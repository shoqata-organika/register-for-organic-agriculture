...
export class LandParcels1709111279961 implements MigrationInterface {
    name = 'LandParcels1709111279961'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "land_parcel_crops" ADD "order" integer NOT NULL DEFAULT '1'`);
        ...
        await queryRunner.query(`ALTER TABLE "subparcels" ADD "id" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "land_parcel_crops" ADD "sub_parcel_id" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "subparcels" ADD CONSTRAINT "PK_7c4f461f28a4bc933019ee5f2ac" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "land_parcel_crops" ADD CONSTRAINT "FK_0c38289c417daa7adb4af2187b9" FOREIGN KEY ("sub_parcel_id") REFERENCES "subparcels"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "land_parcel_crops" DROP COLUMN "order"`);
    }
